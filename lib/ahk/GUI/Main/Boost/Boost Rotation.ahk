...
Gui, Main:Add, ListBox, x16 y50 wp h230, % StrReplace(BoostRotationList, CurrentlySelectedBoost, CurrentlySelectedBoost "|")
...
Gui, Main:Add, ListBox, x136 yp wp h230 +Sort, %NonBoostRotationList%
...
Gui, Main:Add, Button, x104 y100 w24, <-
...
Gui, Main:Add, Button, xp yp+24 wp, ->
...
Gui, Main:Add, Button, xp y156 wp, /\
